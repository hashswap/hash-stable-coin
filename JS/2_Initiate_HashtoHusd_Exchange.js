...
async function run()
{
    ...
    var amount = 26000;
    var args = [
    { vname: 'to', type: 'ByStr20', value: trader1_Address },
    { vname: 'amount', type: 'Uint128', value: amount.toString() },
    ];
    var gas = Long.fromNumber(50000);
    var tx = await sc_call(Hash, transition, args, owner, gas);
    ...
    ////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////
    // 2. Call "ConvertHashtoHusd" in HUSD
    // called by Trader1
    ////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////
   
    var transition = 'ConvertHashtoHusd';
    var amount = 15000;
    var args = [
    { vname: 'amount', type: 'Uint128', value: amount.toString() },
    ];
    var gas = Long.fromNumber(50000);
    var tx = await sc_call(Hash, transition, args, trader1, gas);
    consoleLog("TRANSACTION LOG ", "", tx.receipt, "");

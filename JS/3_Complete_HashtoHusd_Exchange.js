...
async function run()
{
    ...
    var transition = 'resumeTransfer';
    var nonce = 1;
    var hashHusd = 500000;
    var args = [
    { vname: 'non', type: 'Uint128', value: nonce.toString() },
    { vname: 'hashHusd', type: 'Uint128', value: hashHusd.toString() },
    ];
    var gas = Long.fromNumber(50000);
